...
const DEFAULT_SETTINGS: AppSettings = {
    ...
    aboutContent: {
      ...
      p1: {
          vi: '<strong>Phụng Vụ Vinh Sơn</strong> là một ứng dụng web được thiết kế để cung cấp các bài đọc và tài liệu phụng vụ cho các ngày lễ trong lịch Vinh Sơn. Mục tiêu của chúng tôi là làm cho các nguồn tài liệu này dễ dàng truy cập cho các thành viên của gia đình Vinh Sơn và tất cả những ai quan tâm đến linh đạo Vinh Sơn.',
      ...
      li1: { vi: 'Tiểu sử các thánh và các chân phước trong gia đình Vinh Sơn', en: 'Biographies of Vincentian saints.' },
      ...
      p4: { vi: 'Mọi ý kiến đóng góp xin vui lòng liên hệ với Ban truyền thông Tu Hội Truyền Giáo - Tỉnh dòng Việt Nam.', en: 'For any feedback or suggestions, please contact the administration.' },
